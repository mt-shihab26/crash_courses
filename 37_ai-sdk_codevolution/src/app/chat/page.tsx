        ...
        <div className="flex flex-col w-full max-w-md mx-auto h-[calc(100vh-6rem)]">
            ...
            >
                <div className="flex gap-2">
                    <input placeholder="How can I help you?" className="flex-1 p-2 border border-zinc-300" value={prompt} onChange={e => setPrompt(e.target.value)} />
                    <button disabled={status !== 'ready'} type="submit" className="bg-blue-500 text-white px-4 py-2 rounded transition">
                        Send
                    </button>
                </div>
            </form>
