...
const UploadPage = () => {
    ...
    const upload = async (e: ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            setMessage({ type: 'error', text: 'An error occurred while uploading PDF' });
        } finally {
            setLoading(false);
        }
    };
                ...
                <Card className="mb-6">
                    <CardContent className="pt-6">
                        <div className="space-y-4">
                            ...
                            <Input id="pdf-upload" type="file" accept=".pdf" onChange={upload} disabled={loading} className="mt-2" />
                        </div>
                        {loading && (
